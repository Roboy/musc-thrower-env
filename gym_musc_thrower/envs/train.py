...
# model = PPO2(MlpPolicy, env, verbose=1, tensorboard_log="./throwing_tensorboard_ddpg/",  vf_coef=1.0, ent_coef=0.01, n_steps=32, nminibatches=4, noptepochs=3, cliprange=0.3, gamma=0.8, lam=0.9) # normalize_returns=Truelearning_rate=0.00003,)
# try:
